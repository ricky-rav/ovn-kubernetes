...
func isDefaultNetworkAdvertised(routeAdvertisementName string) bool {
	podNetworkValue, err := e2ekubectl.RunKubectl("default", "get", "ra", routeAdvertisementName, "--template={{index .spec.advertisements 0}}")
	if err != nil {
		return false
	}
