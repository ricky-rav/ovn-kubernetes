...
import (
	...
	k8scnicncfiov1beta2 "github.com/k8snetworkplumbingwg/multi-networkpolicy/pkg/apis/k8s.cni.cncf.io/v1beta2"
	...
	v1beta2 "github.com/k8snetworkplumbingwg/multi-networkpolicy/pkg/client/listers/k8s.cni.cncf.io/v1beta2"
...
type MultiNetworkPolicyInformer interface {
	...
	Lister() v1beta2.MultiNetworkPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.K8sCniCncfIoV1beta2().MultiNetworkPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.K8sCniCncfIoV1beta2().MultiNetworkPolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&k8scnicncfiov1beta2.MultiNetworkPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *multiNetworkPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&k8scnicncfiov1beta2.MultiNetworkPolicy{}, f.defaultInformer)
}

func (f *multiNetworkPolicyInformer) Lister() v1beta2.MultiNetworkPolicyLister {
	return v1beta2.NewMultiNetworkPolicyLister(f.Informer().GetIndexer())
}
