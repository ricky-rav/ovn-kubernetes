...
func (ncc *networkClusterController) NADToInterConnect() string {
	return ""
}

func (ncc *networkClusterController) StartInterConnect(icInfo *util.InterConnectInfo) error {
	panic("unexpected call for Network Cluster Controller")
}

func (ncc *networkClusterController) StopInterConnect(icInfo *util.InterConnectInfo) error {
	panic("unexpected call for Network Cluster Controller")
}
