...
type SubnetAllocator interface {
	...
	AllocateIPv4Network(string, int) (*net.IPNet, error)
...
func (sna *BaseSubnetAllocator) AllocateNetworks(owner string) ([]*net.IPNet, error) {
	...
	var err error
	ipv4network, err := sna.AllocateIPv4Network(owner, 0)
	if err != nil {
		return nil, err
	}
	if ipv4network != nil {
...
func (sna *BaseSubnetAllocator) AllocateIPv4Network(owner string, numIPs int) (*net.IPNet, error) {
	sna.Lock()
	defer sna.Unlock()
