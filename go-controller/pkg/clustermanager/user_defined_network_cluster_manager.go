...
func (sncm *userDefinedNetworkClusterManager) GetDefaultNetworkController() networkmanager.BaseNetworkController {
	return nil
}
...
func (sncm *userDefinedNetworkClusterManager) isTopologyManaged(nInfo util.NetInfo) bool {
	...
	case ovntypes.Layer3Topology:
		...
		return nInfo.IsUserDefinedNetwork()
...
func (sncm *userDefinedNetworkClusterManager) newDummyNetworkController(topoType, netName string) (networkmanager.NetworkController, error) {
	netInfo, _ := util.NewNetInfo(&ovncnitypes.NetConf{NetConf: cnitypes.NetConf{Name: netName}, Topology: topoType}, nil)
