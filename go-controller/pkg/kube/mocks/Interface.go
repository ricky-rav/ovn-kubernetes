...
type NewKubeInterfaceT interface {
	mock.TestingT
	Cleanup(func())
}

// NewKubeInterface creates a new instance of KubeInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewKubeInterface(t NewKubeInterfaceT) *KubeInterface {
	mock := &KubeInterface{}
	mock.Mock.Test(t)
