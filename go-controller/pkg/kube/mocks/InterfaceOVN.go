...
func (_m *InterfaceOVN) GetVirtualIP(namespace string, name string) (*virtualipv1beta1.VirtualIP, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetVirtualIP")
	}

	var r0 *virtualipv1beta1.VirtualIP
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) (*virtualipv1beta1.VirtualIP, error)); ok {
		return rf(namespace, name)
	}
...
func (_m *InterfaceOVN) UpdateVirtualIPStatus(vip *virtualipv1beta1.VirtualIP) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateVirtualIPStatus")
	}
