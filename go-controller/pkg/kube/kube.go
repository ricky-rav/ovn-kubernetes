...
import (
	...
	adminpbrclientset "github.com/ovn-kubernetes/ovn-kubernetes/go-controller/pkg/crd/adminpbr/v1beta1/apis/clientset/versioned"
	...
	ipreservationclientset "github.com/ovn-kubernetes/ovn-kubernetes/go-controller/pkg/crd/ipreservation/v1beta1/apis/clientset/versioned"
...
type Interface interface {
	...
	SetLabelsOnPod(pod *corev1.Pod, labels map[string]string) error
...
func (k *Kube) SetLabelsOnPod(pod *corev1.Pod, labels map[string]string) error {
	var err error
	var patchData []byte
	patch := struct {
...
func (k *KubeOVN) UpdateIPReservationStatus(ipresv *ipreservationv1beta1.IPReservation) error {
