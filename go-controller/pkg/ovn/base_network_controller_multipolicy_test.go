...
import (
	...
	"github.com/k8snetworkplumbingwg/multi-networkpolicy/pkg/apis/k8s.cni.cncf.io/v1beta2"
)
...
func multiNetPolicyWithIngressIPBlock() *v1beta2.MultiNetworkPolicy {
	return &v1beta2.MultiNetworkPolicy{
		Spec: v1beta2.MultiNetworkPolicySpec{
			Ingress: []v1beta2.MultiNetworkPolicyIngressRule{
				{
					From: []v1beta2.MultiNetworkPolicyPeer{
						{
...
func multiNetPolicyWithEgressIPBlock() *v1beta2.MultiNetworkPolicy {
	return &v1beta2.MultiNetworkPolicy{
		Spec: v1beta2.MultiNetworkPolicySpec{
			Egress: []v1beta2.MultiNetworkPolicyEgressRule{
				{
					To: []v1beta2.MultiNetworkPolicyPeer{
						{
							IPBlock: &v1beta2.IPBlock{
								CIDR: "10.10.0.0/16",
							},
...
func multiNetPolicyWithIngressPodSelector(policyName string) *v1beta2.MultiNetworkPolicy {
	return &v1beta2.MultiNetworkPolicy{
		ObjectMeta: metav1.ObjectMeta{Name: policyName},
		Spec: v1beta2.MultiNetworkPolicySpec{
			Ingress: []v1beta2.MultiNetworkPolicyIngressRule{
				{
					From: []v1beta2.MultiNetworkPolicyPeer{{PodSelector: sameLabelsEverywhere()}},
				},
			},
		},
	}
...
func multiNetPolicyWithEgressPodSelector(policyName string) *v1beta2.MultiNetworkPolicy {
	return &v1beta2.MultiNetworkPolicy{
		ObjectMeta: metav1.ObjectMeta{Name: policyName},
		Spec: v1beta2.MultiNetworkPolicySpec{
			Egress: []v1beta2.MultiNetworkPolicyEgressRule{
				{
					To: []v1beta2.MultiNetworkPolicyPeer{{PodSelector: sameLabelsEverywhere()}},
				},
			},
		},
	}
...
func multiNetPolicyWithIngressNamespaceSelector(policyName string) *v1beta2.MultiNetworkPolicy {
	return &v1beta2.MultiNetworkPolicy{
		ObjectMeta: metav1.ObjectMeta{Name: policyName},
		Spec: v1beta2.MultiNetworkPolicySpec{
			Ingress: []v1beta2.MultiNetworkPolicyIngressRule{
				{
					From: []v1beta2.MultiNetworkPolicyPeer{{NamespaceSelector: sameLabelsEverywhere()}},
				},
			},
		},
	}
...
func multiNetPolicyWithEgressNamespaceSelector(policyName string) *v1beta2.MultiNetworkPolicy {
	return &v1beta2.MultiNetworkPolicy{
		ObjectMeta: metav1.ObjectMeta{Name: policyName},
		Spec: v1beta2.MultiNetworkPolicySpec{
			Egress: []v1beta2.MultiNetworkPolicyEgressRule{
				{
					To: []v1beta2.MultiNetworkPolicyPeer{{NamespaceSelector: sameLabelsEverywhere()}},
				},
			},
		},
	}
