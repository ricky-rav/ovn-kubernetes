...
// GetASHashNames provides a mock function with no fields
...
// GetASUUID provides a mock function with no fields
func (_m *AddressSet) GetASUUID() (string, string) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetASUUID")
	}
...
func (_m *AddressSet) GetUuids() (string, string) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetUuids")
	}
