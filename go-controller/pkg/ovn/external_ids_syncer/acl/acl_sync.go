...
func (syncer *aclSyncer) GetUpdatedACLs(legacyACLs []*nbdb.ACL) (updatedACLs []*nbdb.ACL,
	...
	updatedACLs = append(updatedACLs, newUpdatedACLs...)
	deleteOps = append(deleteOps, deleteACLs...)
	return updatedACLs, deleteOps, nil
}
...
func (syncer *baseAclSyncer) GetUpdatedACLs(legacyACLs []*nbdb.ACL) (updatedACLs []*nbdb.ACL,
	...
	if err != nil {
		return updatedACLs, deleteOps, fmt.Errorf("failed to update gress policy ACLs: %w", err)
	}
...
func (syncer *baseAclSyncer) SyncACLs(getUpdatedACLs func([]*nbdb.ACL) ([]*nbdb.ACL,
	...
	if len(legacyACLs) > 0 {
		updatedACLs, deleteACLs, err := getUpdatedACLs(legacyACLs)
		if err != nil {
			return err
		}
