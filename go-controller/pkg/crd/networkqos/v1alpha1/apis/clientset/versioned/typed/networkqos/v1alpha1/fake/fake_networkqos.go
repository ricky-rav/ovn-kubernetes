...
var networkqosesResource = v1alpha1.SchemeGroupVersion.WithResource("networkqoses")

var networkqosesKind = v1alpha1.SchemeGroupVersion.WithKind("NetworkQoS")

// Get takes name of the networkQoS, and returns the corresponding networkQoS object, and an error if there is any.
func (c *FakeNetworkQoSes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkQoS, err error) {
	emptyResult := &v1alpha1.NetworkQoS{}
	obj, err := c.Fake.
	...
	return obj.(*v1alpha1.NetworkQoS), err
}

// List takes label and field selectors, and returns the list of NetworkQoSes that match those selectors.
func (c *FakeNetworkQoSes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkQoSList, err error) {
	emptyResult := &v1alpha1.NetworkQoSList{}
	obj, err := c.Fake.
	...
	list := &v1alpha1.NetworkQoSList{ListMeta: obj.(*v1alpha1.NetworkQoSList).ListMeta}
	for _, item := range obj.(*v1alpha1.NetworkQoSList).Items {
...
func (c *FakeNetworkQoSes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeNetworkQoSes) Create(ctx context.Context, networkQoS *v1alpha1.NetworkQoS, opts v1.CreateOptions) (result *v1alpha1.NetworkQoS, err error) {
	emptyResult := &v1alpha1.NetworkQoS{}
	obj, err := c.Fake.
...
func (c *FakeNetworkQoSes) Update(ctx context.Context, networkQoS *v1alpha1.NetworkQoS, opts v1.UpdateOptions) (result *v1alpha1.NetworkQoS, err error) {
	emptyResult := &v1alpha1.NetworkQoS{}
	obj, err := c.Fake.
...
func (c *FakeNetworkQoSes) UpdateStatus(ctx context.Context, networkQoS *v1alpha1.NetworkQoS, opts v1.UpdateOptions) (result *v1alpha1.NetworkQoS, err error) {
	emptyResult := &v1alpha1.NetworkQoS{}
	obj, err := c.Fake.
...
func (c *FakeNetworkQoSes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(networkqosesResource, c.ns, name, opts), &v1alpha1.NetworkQoS{})

	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeNetworkQoSes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(networkqosesResource, c.ns, opts, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.NetworkQoSList{})
	return err
}

// Patch applies the patch and returns the patched networkQoS.
func (c *FakeNetworkQoSes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkQoS, err error) {
	emptyResult := &v1alpha1.NetworkQoS{}
	obj, err := c.Fake.
...
func (c *FakeNetworkQoSes) Apply(ctx context.Context, networkQoS *networkqosv1alpha1.NetworkQoSApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.NetworkQoS, err error) {
	if networkQoS == nil {
...
func (c *FakeNetworkQoSes) ApplyStatus(ctx context.Context, networkQoS *networkqosv1alpha1.NetworkQoSApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.NetworkQoS, err error) {
	if networkQoS == nil {
		return nil, fmt.Errorf("networkQoS provided to Apply must not be nil")
	}
	data, err := json.Marshal(networkQoS)
