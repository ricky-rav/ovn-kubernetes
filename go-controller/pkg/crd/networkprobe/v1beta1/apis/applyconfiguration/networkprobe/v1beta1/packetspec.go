...
// apply.
func PacketSpec() *PacketSpecApplyConfiguration {
	return &PacketSpecApplyConfiguration{}
}
...
func (b *PacketSpecApplyConfiguration) WithDSCP(value int) *PacketSpecApplyConfiguration {
	b.DSCP = &value
	return b
}
