...
// apply.
func PortMirrorSource() *PortMirrorSourceApplyConfiguration {
	return &PortMirrorSourceApplyConfiguration{}
}
...
func (b *PortMirrorSourceApplyConfiguration) WithPodSelector(value *v1.LabelSelectorApplyConfiguration) *PortMirrorSourceApplyConfiguration {
	b.PodSelector = value
	return b
}
