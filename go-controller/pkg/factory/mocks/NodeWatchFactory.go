...
// APBRouteInformer provides a mock function with no fields
...
// AddFilteredPodHandler provides a mock function with given fields: namespace, sel, handlerFuncs, processExisting, priority
func (_m *NodeWatchFactory) AddFilteredPodHandler(namespace string, sel labels.Selector, handlerFuncs cache.ResourceEventHandler, processExisting func([]interface{}) error, priority int) (*factory.Handler, error) {
	ret := _m.Called(namespace, sel, handlerFuncs, processExisting, priority)

	if len(ret) == 0 {
		panic("no return value specified for AddFilteredPodHandler")
	}

	var r0 *factory.Handler
	var r1 error
	if rf, ok := ret.Get(0).(func(string, labels.Selector, cache.ResourceEventHandler, func([]interface{}) error, int) (*factory.Handler, error)); ok {
		return rf(namespace, sel, handlerFuncs, processExisting, priority)
	}
	if rf, ok := ret.Get(0).(func(string, labels.Selector, cache.ResourceEventHandler, func([]interface{}) error, int) *factory.Handler); ok {
		r0 = rf(namespace, sel, handlerFuncs, processExisting, priority)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*factory.Handler)
		}
	...
	if rf, ok := ret.Get(1).(func(string, labels.Selector, cache.ResourceEventHandler, func([]interface{}) error, int) error); ok {
		r1 = rf(namespace, sel, handlerFuncs, processExisting, priority)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *NodeWatchFactory) AddPortMirrorHandler(handlerFuncs cache.ResourceEventHandler, processExisting func([]interface{}) error) (*factory.Handler, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for AddPortMirrorHandler")
	}
...
func (_m *NodeWatchFactory) ConfigMapCoreInformer() informerscorev1.ConfigMapInformer {
	ret := _m.Called()
	...
	var r0 informerscorev1.ConfigMapInformer
	if rf, ok := ret.Get(0).(func() informerscorev1.ConfigMapInformer); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(informerscorev1.ConfigMapInformer)
		}
	}
...
// GetAllPods provides a mock function with no fields
...
// GetNamespaces provides a mock function with no fields
...
func (_m *NodeWatchFactory) GetPortMirror(namespace string, name string) (*v1beta1.PortMirror, error) {
	ret := _m.Called(namespace, name)
...
func (_m *NodeWatchFactory) GetPortMirrors() ([]*v1beta1.PortMirror, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetPortMirrors")
	}
	...
	if rf, ok := ret.Get(0).(func() []*v1beta1.PortMirror); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*v1beta1.PortMirror)
...
// LocalPodInformer provides a mock function with no fields
...
// NADInformer provides a mock function with no fields
...
// NamespaceInformer provides a mock function with no fields
...
// NodeCoreInformer provides a mock function with no fields
...
// NodeInformer provides a mock function with no fields
...
// PodCoreInformer provides a mock function with no fields
...
// RouteAdvertisementsInformer provides a mock function with no fields
...
func (_m *NodeWatchFactory) SecretCoreInformer() informerscorev1.SecretInformer {
	ret := _m.Called()
	...
	var r0 informerscorev1.SecretInformer
	if rf, ok := ret.Get(0).(func() informerscorev1.SecretInformer); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(informerscorev1.SecretInformer)
		}
	}
...
// UserDefinedNetworkInformer provides a mock function with no fields
...
// VTEPInformer provides a mock function with no fields
func (_m *NodeWatchFactory) VTEPInformer() vtepv1.VTEPInformer {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for VTEPInformer")
	}

	var r0 vtepv1.VTEPInformer
	if rf, ok := ret.Get(0).(func() vtepv1.VTEPInformer); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(vtepv1.VTEPInformer)
		}
	}
