...
func UpdatePortGroupSetNameAndExternalIDsOps(nbClient libovsdbclient.Client, ops []libovsdb.Operation,
	pg *nbdb.PortGroup, newName string) ([]libovsdb.Operation, error) {
