...
func GetAllNADsSkipPinnedLS(node *corev1.Node) []string {
...
func IsDPU(node *corev1.Node) bool {
...
func GetNodeDPUs(node *corev1.Node) ([]string, error) {
...
func GetNodeMgmtIPs(node *corev1.Node) ([]net.IP, error) {
