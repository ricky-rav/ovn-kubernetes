...
func UpdatePortMirrorStatusOnError(pm *PortMirror, kube kube.InterfaceOVN,
...
// status.
func ClearPortMirrorErrorMessage(pm *PortMirror, kube kube.InterfaceOVN, failedOpsKey string) {
...
func UpdatePortMirrorStatusWithRetry(kube kube.InterfaceOVN, namespace, name string,
	...
	retryErr := retry.RetryOnConflict(retry.DefaultRetry, func() error {
		...
		// update portmirror status field
