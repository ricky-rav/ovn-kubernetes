...
// GatewayMAC provides a mock function with given fields:
func (_m *NetInfo) GatewayMAC() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GatewayMAC")
	}
...
func (_m *NetInfo) Gateways() string {
	...
	if len(ret) == 0 {
		panic("no return value specified for Gateways")
	}
...
// GetAnnotationKey provides a mock function with given fields: _a0
func (_m *NetInfo) GetAnnotationKey(_a0 string) string {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for GetAnnotationKey")
	}
...
// NADRoutes provides a mock function with given fields:
func (_m *NetInfo) NADRoutes() []*net.IPNet {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for NADRoutes")
	}
...
// NADToInterConnect provides a mock function with given fields:
func (_m *NetInfo) NADToInterConnect() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for NADToInterConnect")
	}
...
// XDPService provides a mock function with given fields:
func (_m *NetInfo) XDPService() bool {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for XDPService")
	}
