...
// BridgeVlanAddTunnelInfo provides a mock function with given fields: link, vid, vni, self, master
func (_m *NetLinkOps) BridgeVlanAddTunnelInfo(link netlink.Link, vid uint16, vni uint32, self bool, master bool) error {
	ret := _m.Called(link, vid, vni, self, master)
	...
	if rf, ok := ret.Get(0).(func(netlink.Link, uint16, uint32, bool, bool) error); ok {
		r0 = rf(link, vid, vni, self, master)
	} else {
		r0 = ret.Error(0)
	}
...
// BridgeVlanDelTunnelInfo provides a mock function with given fields: link, vid, vni, self, master
func (_m *NetLinkOps) BridgeVlanDelTunnelInfo(link netlink.Link, vid uint16, vni uint32, self bool, master bool) error {
	ret := _m.Called(link, vid, vni, self, master)
...
func (_m *NetLinkOps) BridgeVlanTunnelShowDev(link netlink.Link) ([]nl.TunnelInfo, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for BridgeVlanTunnelShowDev")
	}

	var r0 []nl.TunnelInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(netlink.Link) ([]nl.TunnelInfo, error)); ok {
		return rf(link)
	}
	if rf, ok := ret.Get(0).(func(netlink.Link) []nl.TunnelInfo); ok {
		r0 = rf(link)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]nl.TunnelInfo)
		}
	}
...
// BridgeVniAdd provides a mock function with given fields: link, vni
func (_m *NetLinkOps) BridgeVniAdd(link netlink.Link, vni uint32) error {
	ret := _m.Called(link, vni)

	if len(ret) == 0 {
		panic("no return value specified for BridgeVniAdd")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(netlink.Link, uint32) error); ok {
		r0 = rf(link, vni)
	} else {
		r0 = ret.Error(0)
	}
...
// BridgeVniDel provides a mock function with given fields: link, vni
func (_m *NetLinkOps) BridgeVniDel(link netlink.Link, vni uint32) error {
	ret := _m.Called(link, vni)

	if len(ret) == 0 {
		panic("no return value specified for BridgeVniDel")
	}
...
// CountIngressFilters provides a mock function with given fields: link
func (_m *NetLinkOps) CountIngressFilters(link netlink.Link) (uint, error) {
	ret := _m.Called(link)

	if len(ret) == 0 {
		panic("no return value specified for CountIngressFilters")
	}
...
func (_m *NetLinkOps) IsAlreadyExistsError(err error) bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for IsAlreadyExistsError")
	}
...
// IsEntryNotFoundError provides a mock function with given fields: err
func (_m *NetLinkOps) IsEntryNotFoundError(err error) bool {
	ret := _m.Called(err)

	if len(ret) == 0 {
		panic("no return value specified for IsEntryNotFoundError")
	}
...
// LinkList provides a mock function with no fields
...
// LinkModify provides a mock function with given fields: link
func (_m *NetLinkOps) LinkModify(link netlink.Link) error {
	ret := _m.Called(link)
