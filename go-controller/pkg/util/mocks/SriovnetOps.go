...
func (_m *SriovnetOps) GetRepresentorVFMissPktDrops(netdev string) (uint64, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetRepresentorVFMissPktDrops")
	}
...
func (_m *SriovnetOps) GetRepresentorVFMissPktRate(netdev string) (uint64, uint64, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetRepresentorVFMissPktRate")
	}
...
// SetRepresentorPeerMacAddress provides a mock function with given fields: netdev, mac
func (_m *SriovnetOps) SetRepresentorPeerMacAddress(netdev string, mac net.HardwareAddr) error {
	ret := _m.Called(netdev, mac)

	if len(ret) == 0 {
		panic("no return value specified for SetRepresentorPeerMacAddress")
	}
...
// SetRepresentorVFMissPktRate provides a mock function with given fields: netdev, maxPPS, maxBurst
func (_m *SriovnetOps) SetRepresentorVFMissPktRate(netdev string, maxPPS uint, maxBurst uint) error {
	ret := _m.Called(netdev, maxPPS, maxBurst)

	if len(ret) == 0 {
		panic("no return value specified for SetRepresentorVFMissPktRate")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(string, uint, uint) error); ok {
		r0 = rf(netdev, maxPPS, maxBurst)
	} else {
		r0 = ret.Error(0)
	}
