...
// 			kObj, err := oc.getResourceFromInformerCache(r.oType, objKey) // TODO this won't need oc
// 			if err != nil {
...
// 		if initObj != nil {
// 			recordSuccessEvent(r.oType, initObj)
// 		}
// 		r.deleteRetryObj(key)
// 	})
// }
...
// 		case <-oc.stopChan: // TODO initialize this in retry_framework struct
...
// 	addHandlerFunc, err := oc.watchFactory.GetResourceHandlerFunc(objectsToRetry.oType) // ok, call watchFactory in your retry_framework struct
// 	if err != nil {
...
// 					recordSuccessEvent(objectsToRetry.oType, obj)
// 				})
// 			},
...
// 					return
// 				}
// 				recordUpdateEvent(objectsToRetry.oType, newer)
...
// 				latest, err := oc.getResourceFromInformerCache(objectsToRetry.oType, newKey) // TODO just needs access to watchFactory
// 				if err != nil {
...
// 					// This only applies to pod watchers (pods + dynamic network policy handlers watching pods).
// 					if kerrors.IsNotFound(err) && isObjectInTerminalState(objectsToRetry.oType, newer) {
...
// 						}
// 					} else if isObjectInTerminalState(objectsToRetry.oType, latest) { // check the latest status on newer
...
// 					}
// 					objectsToRetry.deleteRetryObj(key)
// 					recordSuccessEvent(objectsToRetry.oType, latest)
// 				})
// 			},
