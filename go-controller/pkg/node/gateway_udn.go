...
func (b *bridgeConfiguration) getBridgePortConfigurations() ([]bridgeUDNConfiguration, string, string, string, string, string, *sync.Map) {
	...
	hostRepName := b.hostRepName
	if config.OvnKubeNode.Mode == types.NodeModeDPU {
		hostRepName = b.dpuHostRepName
	}
	return netConfigs, b.uplinkName, b.ofPortPhys, hostRepName, b.ofPortHost, b.bridgeName, b.localnetPatchPorts
}
